            ...
            <div className="summary-list">
                ...
                <div className="summary-item">
                    ...
                    <div className="summary-info">
                        ...
                        <p className="s-value">{todaySummary.checkIn || '-- : -- : --'}</p>
                    </div>
                </div>
                ...
                <div className="summary-item">
                    ...
                    <div className="summary-info">
                        ...
                        <p className="s-value">{todaySummary.checkOut || '-- : -- : --'}</p>
                    </div>
                </div>
                ...
                <div className="summary-item s-item-progress">
                    ...
                    <div className="summary-info s-info-full">
                        ...
                        <div className="s-progress-header">
                            <p className="s-value">{todaySummary.totalHours || '00h 00m'}</p>
                            <div className="s-progress-track">
                                <div className="s-progress-fill" style={{ width: '60%' }}></div>
                            </div>
                        </div>
                    </div>
                </div>
