...
const AttendanceTable = () => {
    ...
    const getSourceIcon = (source) => {
        switch (source) {
            case 'Web App': return <Monitor size={14} className="icon-margin" />;
            case 'Mobile App': return <Smartphone size={14} className="icon-margin" />;
            case 'Punch Machine': return <Cpu size={14} className="icon-margin" />;
            default: return <XCircle size={14} className="icon-margin text-muted" />;
        }
    };
